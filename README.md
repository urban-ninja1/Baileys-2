...
## Thanks everyone for starring my humble repo. I'm very flattered. Please notice that Baileys community created a new mantained repository https://github.com/WhiskeysSockets/Baileys. You should use it for getting edge features. Otherwise if you interested in my fully functional, scalable, open source and free WhatsApp REST [BASIS API](https://basis-api.com) service based on baileys then welcome to stay with me.

| :exclamation: As we all know famous @adiwajshing closed the original Baileys library since he received a cease & desist from WhatsApp. I fully respect his desicion but since library is under GPL-3 we have freedom to share and change the library to suit our needs. This fork contains latest sources of Baileys commited in Master branch and native-mobile-api pull-request sources placed to separate branch. Also i have set up builds and published first release 5.1.0. Now the fork is going to be mantained by me and i hope by community. The fork is used in real project [BASIS API](https://basis-api.com) so i'm being involved and fully interested in it's future. I'm hoping that community will help and join. Surely copyright belongs to @adiwajshing and I hope the author changes his mind and comes back one day. Since repository might be blocked we must be prepared. I'm going to create mirrors and use own git server. News are coming soon .But for now enjoy the 5.1.0. release!|
|-----------------------------------------|
...
``` ts 
import makeWASocket from '@yard-team/baileys'
```
...
``` ts
import makeWASocket, { DisconnectReason } from '@yard-team/baileys'
...
``` ts
import makeWASocket, { BufferJSON, useMultiFileAuthState } from '@yard-team/baileys'
...
``` ts
import makeWASocket, { makeInMemoryStore } from '@yard-team/baileys'
...
``` ts
import { MessageType, MessageOptions, Mimetype } from '@yard-team/baileys'
...
- **MiscGenerationOptions**: some extra info about the message. It can have the following __optional__ values:
    ...
    const info: MessageOptions = {
        ...
        mimetype: Mimetype.pdf, /* (for media messages) specify the type of media (optional for all media types except documents),
                                    import {Mimetype} from '@yard-team/baileys'
                                */
...
import { downloadMediaMessage } from '@yard-team/baileys'

...
## Thanks everyone for starring my humble repo. I'm very flattered. Please notice that Baileys community created a new mantained repository https://github.com/WhiskeysSockets/Baileys. You should probably use it for getting edge features. Otherwise if you interested in my fully functional, scalable, open source and free WhatsApp REST [BASIS API](https://basis-api.com)  based on baileys then welcome to stay with me.

 ...
 */
export function mobileRegisterCode(params: RegistrationParams, agent?: Agent) {
...
export async function mobileRegisterFetch(path: string, opts: { params?: Record<string, string>, headers?: Record<string, string>,  agent?: Agent} = {}) {
